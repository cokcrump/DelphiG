// Updated to new CPR+ Server tx-cprsql01 11/04/13
// Abreviated First Name 12/27/13
// Date file sent to S Drive for Steve Laycock 10/21/14
// Added append to file and csv extension 12/15/14
// Second modification for ZP 450 printers 6/5/15
// Added delivery type 8/27/15
// Added Delivery Type Lock 9/17/15
// Added Sleep Delay for printing, Radio button for Locking OrderType, Excepting handling 9/29/15
// Modified date size to add seperation between date and order number 10/23/15

// Warehouse Anaytics Version 1 July 8, 2016
// Warehouse Order Tracking Version 2
// Cleared Order Method for Triage, Assign, Staging July 28, 2016
// Modified label print size for Quanity Labels July 28, 2016
// Added directive to select printers Aug 3, 2016
// Added lock for employee in QC Aug.8, 2016
// Fixed Graphic for USB changed OrderType to OrderMethod Aug.23, 2016

// Version  (Warehouse Tracking Duplicate) Release Date Sep.14, 2016
// Changed date format in ADOInsWhs SEP 12, 2016
// Added Station to dup check SEP 12, 2016
// Dup count not working, >= to ADODupChk SEP 15, 2016
// Check for lock when returning from dup check SEP 15, 2016
// Removed ordertype 'QC' when station in QC Sep.22, 2016

// Version MCCA2 Release Oct.14,2016
// Added employee field to staging 10/07/16
// Error checking for numeric on employee field 10/07/16
// Expanded Dup Check grid for Rod 10/12/16
// Added package count to insert statement, was missed earlier 10/14/16
// Error checking for alpha field on employee field 10/14/16
// Widened Duplicate Screen  10/14/16

// Version Release Oct.21,2016
// Checked length of Field for Employee(6) and Order(7) 10/21/16
// Added duplicate to database when 'NO' selected on message 10/21/16

// Not Released
// Added employee number to Duplicate Grid 10/26/2016
// Added 24 hour timestamp to database 10/31/2016

// Plano move LP new server name LP-CPRSQLPDR01 11/14/16


// Version 12  Released Dec.9, 2016
// Created new tabs for (Order History) and (New Label) 11/24/16
// Added all fields and employee name to Order History Grid  11/24/16
// Increased font size on input fields 11/24/16

// Added new Date Field NDTS 12/01/16
// Corrected Offset for Parellel Port printing of Label  12/07/16
// Added shipping date 12/07/16
// Removed duplicate (yes/no) box 12/09/16
// Changed duplicate grid color to red for duplicate 12/09/16
// Replaced Printer with offset, Middle Station 12/09/16


// Version 13 Not Released
// Added Dispatch station 12/21/16 Winter Solitice
// On tab switch from 'Order History' to 'Input' set focus on proper fields 1/16/17
// Order History - Moved World Ship date from grid to Edit field 3/27/17
// Increased Font Size 4/12/17
// Added Work Order tab  4/12/17

// Version 14
// Added option for selecting printer type  6/5/17
// Tested using GX420d printers  6/5/17
// Displays Printer in Caption 6/5/17

// Version 15
// Added error code section. 6/9/17
// Added error checking 8/3/17
// Changed error code from Cap to regular 8/7/17
// Cleared fields on Save - Error Codes 8/8/17

// Version 16
// Fixed the following
// Notes Can't focus    10/2/17
// Clear Notes Error    10/2/17
// Processed label covered  10/2/17
// Can't click Error RadioButton Off  10/2/17

// Version 17
// Added overide on triage to exit out of error screen Rod Norton only 10/18/17
// Prvented Error exiting to input on overide 10/18/17
// Default employee number to ***** on edit bost 10/30/17

// Version 18
// Fixed disabled window error, added if statement on Save (Record Error) 11/1/17
